...
public class PlantController implements Serializable {
    ...
    public void removePlantFromFile(String plantName){
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(orgFile));
            ...
            System.out.println("Error removing /discarding plant!");
    ...
    /**
     * This method saves the PlantController object to a file.
     * It uses the ObjectOutputStream to write the object.
     * @author Yrja Mai Hoang
     ...
     * @return the PlantController object
     */
    ...
    //Don't know why it says that I have written this one, might be because of me resetting the merge
    //That's my bad, but who ever has written this one just write your name here
    //Actually written by: Akmal Safi

    /**
     * @author Akmal Safi
     */
    public void timeTrackWriter() { // need to specify how we write the progress for three plants
